#include "animation/skeletal_animation_manager.h"
...
namespace TheEngine::Animation
{
    ...
    SkeletalAnimationManager::SkeletalAnimationManager(Memory::GPUBufferManager& gpuBufferManager)
    {
    ...
    Memory::GPUBufferInfo SkeletalAnimationManager::getJointMatrixSSBO()
    {
